        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
            <div className="text-center lg:text-left">
                ...
                <ul className="list-disc mx-4 md:mx-8 my-4 marker:text-[#443627]">
                    ...
                    <li className="font-semibold ">You can get the scrapped data <a className="link text-[#D98324]" href="https://github.com/AuvroIslam/Olympic_vs_Gdp/tree/main/data">here.</a></li>
                    <li className="font-semibold ">For more details, check out the <a className="link text-[#D98324]" href="https://github.com/AuvroIslam/Olympic_vs_Gdp">full documentation.</a></li>
